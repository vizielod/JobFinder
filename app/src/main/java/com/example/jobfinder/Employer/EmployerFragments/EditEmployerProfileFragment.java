...
public class EditEmployerProfileFragment extends Fragment {
    ...
    private Button mBack, mConfirm, mDeleteBtn;
    ...
    public static EditEmployerProfileFragment newInstance() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        View view = inflater.inflate(R.layout.fragment_edit_employer_profile, container, false);

        mNameField = (EditText) view.findViewById(R.id.employerName);
        mDescriptionField = (EditText) view.findViewById(R.id.employerDescription);
        mIndustryField = (EditText) view.findViewById(R.id.industry);
        mWebsiteField = (EditText) view.findViewById(R.id.websiteURL);
        mFacebookField = (EditText) view.findViewById(R.id.facebook);
        mLinkedInField = (EditText) view.findViewById(R.id.linkedIn);
        mAddressField = (EditText) view.findViewById(R.id.headquarter);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        Log.i(LOGTAG, "EmployerMainFragment " + fragmentActivity);
    ...
    private void saveUserInformation() {
        ...
        if(resultUri != null){
            ...
            try {
                bitmap = MediaStore.Images.Media.getBitmap(fragmentActivity.getApplication().getContentResolver(), resultUri);
            } catch (IOException e) {
                e.printStackTrace();
            }
